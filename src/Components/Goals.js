                        ...
                        <Box sx={{ width: "94%", maxWidth: "600px" }}>
                            {(barChartData !== null) && (
                                 ...
                                 <Box display="flex" justifyContent="space-between">
                                     <Typography variant="subtitle2"><WalletIcon sx={{ marginBottom: "3px", fontSize: "18px" }} /> {(goalSettings?.goalType === "Expense") ? "Spent :" : "Earned :"} ₹{pieChartData?.totalSpent}</Typography>
                                     <Typography variant="subtitle2"><ModeStandbyRoundedIcon sx={{ marginBottom: "3px", fontSize: "18px" }} /> Goal : ₹{goalSettings.goalAmount}</Typography>
                                 </Box>
                             </Card>
                            )}
